...
export default function Hero() {
  return (
    <section className="relative w-full h-[85vh] min-h-[600px] overflow-hidden bg-[var(--bg)]">
      {/* Gradient background — light Damas style */}
      <div className="absolute inset-0 bg-[#063d30]" />
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(circle at 30% 40%, rgba(252,215,24,0.4) 0%, transparent 60%), radial-gradient(circle at 70% 60%, rgba(252,215,24,0.2) 0%, transparent 50%)" }} />
